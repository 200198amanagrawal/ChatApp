...
import com.example.chatapp.AllFragments.ChatWork.MessagesAdapter;
                ...
                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                    ...
                    m_gorupRef.child(userID).child(msgPushID).updateChildren(msgTextBody).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            ...
                            {
                                Toast.makeText(Group_ChatActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                            }
